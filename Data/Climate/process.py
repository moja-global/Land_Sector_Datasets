...
gdalwarp_cmd = 'gdalwarp -t_srs EPSG:4326 -dstnodata 255.0 -tr 0.005 0.005 -r near -te -180.0 -90.0 180.0 90.0 -te_srs EPSG:4326 -of GTiff CLIMATE_ZONE.rst IPCC_ClimateZoneMap.tif'
